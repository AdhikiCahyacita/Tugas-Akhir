    ...
    <main class="form-signin">
      <form action="/register" method="POST">
       ...
       @enderror
        ...
        <div class="form-floating">
          <input type="tel" name="telf_number" class="form-control @error('telf_number') is-invalid @enderror" placeholder="telf_numberr" value="{{ old('telf_number') }}">
          <label for="floatingPhone">telf_number</label>
          @error('telf_number')
            <div class="invalid-feedback">{{ $message }}</div>
          @enderror
        </div>
